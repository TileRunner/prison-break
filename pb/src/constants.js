...
export const PARTY_TYPE_OBSERVER = 'O'; // Observer (someone watching a game in progress)
export const PARTY_TYPE_EXAMINER = 'E'; // Examiner (someone examing a completed game)
// Whose turn
